...
android {
    ...
    defaultConfig {
        ...
        // v2 backend: use your real Render URL after first deploy (often https://html-basics-test-v2.onrender.com).
        buildConfigField("String", "SUBMIT_BASE_URL", "\"https://html-basics-test-v2.onrender.com\"")
    }
